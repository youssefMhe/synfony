...
mail("mohamedsofien.zitoun@esprit.tn
", "Salut tout le monde !", $message, $header);
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			<div class="contact-form">
				    	...
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="commandecontact.php">
				            ...
				            <div class="form-group col-md-12">
				                <input type="submit" name="submit" class="btn btn-primary pull-right" value="Envoyer" style="background-color: olive; width: 200px;">
				            </div>
				        </form>
	    			</div>
	    		</div>
