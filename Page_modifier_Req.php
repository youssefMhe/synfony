...
include "../core/produitC.php";
	...
	echo "modifier.phpaaaaaaaakkkkkkkkkkkkkkkkk<br>" ; 
	if (    isset($_POST['reference']) and  isset($_POST['qte']) and isset($_POST['prix']) and isset($_POST['description'])and isset($_POST['categorie']) 
		and isset($_POST['marque']) and isset($_POST['couleur'])  and isset($_POST['taille']) and isset($_POST['style'])and isset($_POST['date_expiration'])
		and isset($_POST['forme'])and isset($_POST['largeurBranche']) and isset($_POST['hauteurBranche']) and isset($_POST['largeurVerre']) 
		and isset($_POST['hauteurVerre'])and isset($_POST['typeSolution']) 
		and isset($_POST['imageFront']) and isset($_POST['imageBack'])	and isset($_POST['imageLeft'])and isset($_POST['imageRight'])
	){	
		$Attribuer="" ; 
		if (isset($_POST['H'])){
		...
		$produit1C->modifierProduit($produit1,$_POST['id_pdt']);
	}
