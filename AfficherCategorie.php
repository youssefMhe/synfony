<?php
	...
	$listeProduit1=$produitC->afficherProduits_categorie($_GET['nomCategorie']); // afficher les produits par cateogire 
						...
						<!--price-range-->				
							...
							<div class="slidecontainer">
								<table width="100%">
										...
										<tr>
												<td>0</td>
												<td><input type="range" min="0" max="10000" value="50" class="slider" id="myRange"></td>
												<td>5</td>
										</tr>
								</table>	
									<br>						  
									...
									<div class="choose">
										<ul class="nav nav-pills nav-justified">
											<li>
												...
												<i class="fa fa-plus-square"></i>detaille produit</a>
											</li>
										</ul>
									</div>
								</div>	
