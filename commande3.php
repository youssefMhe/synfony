...
$tab = unserialize($_COOKIE['mozitoun'.$_SESSION['moidcl']]);
//$tab = array($obj,$obj,$obj);
...
$tab[]=$obj;
    $obj->setimage($_SESSION['moimageprodprod']);
$tab_ser = serialize($tab);
...
<body>
  ...
  <form method="post" action="commande3.php" name="mozitoun" >
   <section id="mo">
   <center>
<table  style="width: 80%;" id="tabajoutpanier">
    <tbody>
        ...
        <tr>
           <td><img src="<?php if(isset($_SESSION['moimageprodprod'])) echo$_SESSION['moimageprodprod'];  ?>" style="width: 300px;height: 150px;"></td>
           <td>
            ...
            <p><?php
                ...
                echo "Color : ".$obj->getcolor();
                echo "<br>";
                echo "Verre : ".$obj->getverre();
                echo "<br>";
                echo "Marque de verre : ".$obj->getmarquedeverre();
                echo "<br>";
                echo "type : ".$obj->gettypee();
                echo "<br>";
                echo "type de teinte : ".$obj->gettypeteinte();
                echo "<br>";
                ?></p>
            </td>
            <td>
        ...
        <tr>
            ...
            <td id="annuler"><input type="submit" value="ANNULER" name=""  id="annuler" style="width: 100%;padding: 10px; border: none; border-radius: 90px;" ></td>
